...
class Microbiz_Connector_Model_Product_Attribute_Api extends Mage_Catalog_Model_Product_Attribute_Api
{
	...
	public function options($attributeId, $storeID = null)
	     ...
	     * @return array
	     */
    		return Mage::getModel('Microbiz_Connector_Model_Entity_Attribute_Option_Api')->items($attributeId);
    	}
...
//         $newAttribute = Mage::getModel("catalog/entity_attribute");	// Magento 1.5.x.x and older
        ...
        {
            $optionsModel = Mage::getModel("Microbiz_Connector_Model_Entity_Attribute_Option_Api");
