...
class Microbiz_Connector_Helper_ERunActions extends Mage_Core_Helper_Abstract
{
    ...
    {
        $client = Mage::getModel('Microbiz_Connector_Model_ERunActionsHttpClient');
