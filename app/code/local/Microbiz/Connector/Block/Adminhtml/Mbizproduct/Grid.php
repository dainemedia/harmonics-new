<?php
// Version 100
class Microbiz_Connector_Block_Adminhtml_Mbizproduct_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareCollection()
	{
		...
		$collection = Mage::getModel('mbizproduct/mbizproduct')->getCollection();
